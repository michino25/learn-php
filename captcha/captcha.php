...
$fonts = [
    dirname(__FILE__) . '\fonts\Roboto-Black.ttf',
    dirname(__FILE__) . '\fonts\Roboto-BoldItalic.ttf',
    dirname(__FILE__) . '\fonts\Roboto-Medium.ttf',
    dirname(__FILE__) . '\fonts\Roboto-Regular.ttf'
];
